const CarDetails = () => {
  return (
    <div className=" flex w-[327px] flex-col gap-7 lg:flex-row font-display">
      <figure className="card bg-base-100 shadow-sm rounded-box grid  grow place-items-center">
        <img
          src="https://res.cloudinary.com/dg1qeccqc/image/upload/v1712567777/Cars/Golf.webp	"
          alt="Volkswagen Golf"
        />
      </figure>
      <div className="card bg-base-100 shadow-sm rounded-box grid  grow gap-[30px] p-[30px]">
        <div>
        ...
        <div className="flex flex-col gap-3.5">
          <ul className="text-sm text-neutral-400 flex flex-col gap-3.5">
        ...
        <div className="card-actions flex-col items-start gap-5">
          <p className="text-2xl font-bold ">
            € 50 / <span className="text-neutral-400 text-base">day</span>
          </p>
          <button className="btn btn-primary w-full text-sm">Rent Now</button>
        </div>
      </div>
      <div className="card bg-base-100 shadow-sm rounded-box grid  grow place-items-center">
        content
      </div>
    </div>
  );
