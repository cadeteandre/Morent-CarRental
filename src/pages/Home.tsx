  ...
  return (
    <section className="p-4 flex flex-col gap-6 items-center">
      ...
      <section className="flex flex-col md:flex-row items-center gap-4">
        ...
        />
        <button
          className="btn bg-blue-600 text-white h-fit p-4 cursor-pointer rounded-sm hover:bg-blue-800"
      ...
      <section className="w-full items-center flex justify-between">
        <button
          className="btn bg-blue-600 text-white text-xs font-Jakarta-SemiBold"
          onClick={loadMore}
        >
          Load More
        </button>
